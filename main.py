...
def get_option():
    ...
    parser.add_argument("--augment_small_range", type=int, default=30, help="The small range for augumentation")
    parser.add_argument("--augment_large_range", type=int, default=100, help="The large range for augmentation")
    parser.add_argument("--augment_small_per", type=int, default=0.3, help="The small range for augumentation")
